...
public class Album implements Serializable, Comparable<Album> {
	...
	//Get the ArrayList of ImageView objects from the album.  (Looks at every photo and grabs its ImageView)
	/**
	 * gets an Imageview list from the photo list
	 * @return returns an arraylist of imageview objects
	 */
	...
	//Given an ImageView, returns the photo that it belongs to.
	/**
	 * gets a photo object from an imageview object
	 * @param img imageview object
	 * @return returns a photo object
	 */
	public Photo getPhotoFromImage(ImageView img) {
		for(Photo photo: photos_list) {
	...
	/*
	//sets the ImageView of a Photo
	public void setImageInPhoto(ImageView view) {
